...
AProjectSteelHud::AProjectSteelHud(const FObjectInitializer& ObjectInitializer) 
...
void AProjectSteelHud::DrawHUD()
{
	...
	if( bHMDDeviceActive == false )
	{
		...
		AProjectSteelPawn* Vehicle = Cast<AProjectSteelPawn>(GetOwningPawn());
